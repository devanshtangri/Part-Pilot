...
DEFAULT_APP_SETTINGS: dict[str, dict[str, object]] = {
    ...
    "mcp.tool_permissions": {"value_json": {"search_parts": True, "get_part_details": True, "list_projects": True, "get_project_details": True, "list_reservations": True, "get_reservation_details": True, "reserve_project": False, "consume_reservation": False, "cancel_reservation": False, "adjust_part_quantity": False}, "value_text": None},
}
