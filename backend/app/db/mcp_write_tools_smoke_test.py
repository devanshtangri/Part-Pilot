...
WRITE_TOOLS = {"reserve_project", "consume_reservation", "cancel_reservation", "adjust_part_quantity", "create_part", "update_part_metadata", "soft_delete_part", "restore_part"}
...
def main() -> None:
    ...
    try:
        ...
        if set(asyncio.run(mcp_registered_tool_names())) != ALL_TOOLS:
            fail("FastMCP registry does not contain six read plus eight write tools")
