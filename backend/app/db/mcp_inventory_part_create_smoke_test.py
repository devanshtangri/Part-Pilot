...
EXPECTED_HEAD = "0020_mcp_inventory_part_create"
...
def main() -> None:
    ...
    try:
        ...
        try:
            ...
            if len(DEFAULT_MCP_TOOL_PERMISSIONS) != 11 or CREATE_TOOL not in DEFAULT_MCP_TOOL_PERMISSIONS:
                fail("Expected canonical six-read plus five-write tool policy")
