...
def _serialize_stock_movement(
    ...
    return StockMovementResponse(
        ...
        reserved_quantity_before=movement.reserved_quantity_before,
        reserved_quantity_after=movement.reserved_quantity_after,
        available_quantity_before=movement.available_quantity_before,
        available_quantity_after=movement.available_quantity_after,
